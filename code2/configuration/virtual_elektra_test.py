...
class configDrive:
  ...
  def __init__(self):
    ...
    self.carla_config ="./drive_interfaces/carla/elektra_test.ini"   # The path to carla ini file # TODO: make this class to be able to generate the ini file
    self.host = "127.0.0.1"
    self.port = 2000
