...
class configInput(configMain):
    def __init__(self):
        ...
        all_files = glob.glob("/data/yang/code/aws/scratch/carla_collect/9/*/data_*.h5")
        self.val_db_path = glob.glob("/data/yang/code/aws/scratch/carla_collect/9/*WeatherId=13/data_*.h5")
