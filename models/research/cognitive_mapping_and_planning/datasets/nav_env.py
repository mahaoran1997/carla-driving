...
class NavigationEnv(GridWorld, Building):
  ...
  def reset(self, rngs):
    ...
    print ("---------------------reset_data__________________________")
    print start_nodes, start_node_ids, goal_nodes, goal_node_ids, dists, perturbs, end_perturbs, history, target_class
    return start_node_ids
    '''mhr: [(184, -136, 2), (-88, -104, 3), (-88, -792, 1), (176, -672, 1)] [6595, 7606, 909, 6883] [[(216, -192, 1), (-168, -88, 0), (-112, -904, 1), 
    (224, -624, 1)]] [[5831, 2543, 4422, 4074]] [[array([ 41, 166,  23, ...,  82, 122, 169], dtype=int32), array([139,  46, 157, ...,  82,  56, 
    49], dtype=int32), array([119, 138, 137, ...,  62,  92, 141], dtype=int32), array([ 62, 133,  80, ...,  49,  89, 136], dtype=int32)]]
    '''
...
class BuildingMultiplexer():
  ...
  def __init__(self, args, task_number):
    ...
    # mhr: in training depth images: Env Class: datasets.nav_env.VisualNavigationEnv
